    ...
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "2rem 1.5rem", color: "#eee", fontFamily: "Outfit, sans-serif" }}>
      ...
      <div style={{ textAlign: "center", marginBottom: "2.5rem" }}>
        ...
        <p style={{ color: "#888", marginTop: "0.5rem" }}>
          Nowe i używane części do motocykli – szybka wysyłka w całej Polsce
        </p>
      </div>
        ...
        <div style={{ display: "flex", gap: "0.5rem", flexWrap: "wrap" }}>
          <button
            ...
            style={{
              ...
              borderRadius: 20,
              border: "1px solid",
              borderColor: !category ? "#f60" : "#444",
              background: !category ? "#f60" : "transparent",
          ...
          {CATEGORIES.map((cat) => (
            <button
              ...
              style={{
                ...
                borderRadius: 20,
                border: "1px solid",
                borderColor: category === cat ? "#f60" : "#444",
                background: category === cat ? "#f60" : "transparent",
...
export default function ShopClient() {
  return (
    <Suspense
      fallback={
        <div style={{ textAlign: "center", padding: "4rem", color: "#666", fontFamily: "Outfit, sans-serif" }}>
          Ładowanie…
        </div>
      }
    >
